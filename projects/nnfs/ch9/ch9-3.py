# backpropagating through a layer, simplified
...
# here, see how we can combine all these equations into one to make them simpler
# and remove the use of all these intermediary variables
...
print(dReLU_dx0, dReLU_dw0, dReLU_dx1, dReLU_dw1, dReLU_dx2, dReLU_dw2, dReLU_db)